...
import (
	...
	vipermodule "viper/x/viper"
	vipermodulekeeper "viper/x/viper/keeper"
	vipermoduletypes "viper/x/viper/types"
...
type App struct {
	*baseapp.BaseApp
	...
	ViperKeeper vipermodulekeeper.Keeper
...
func New(
	...
	app.ViperKeeper = *vipermodulekeeper.NewKeeper(
		appCodec,
		keys[vipermoduletypes.StoreKey],
		keys[vipermoduletypes.MemStoreKey],
		app.GetSubspace(vipermoduletypes.ModuleName),
	)
	viperModule := vipermodule.NewAppModule(appCodec, app.ViperKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(vipermoduletypes.ModuleName)
